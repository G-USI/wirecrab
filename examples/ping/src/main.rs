...
async fn main() {
    ...
    // Subscriber uses the schema generated by the macro
    let sub_codec = JsonCodec::new(&PingApp::schema_ping()).unwrap();
    ...
    // Publisher
    let pub_codec = JsonCodec::new(&PingApp::schema_ping()).unwrap();
